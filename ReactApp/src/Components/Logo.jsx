...
const Logo = () => {
  return (
    <svg
      viewBox="0 0 889 917"
      focusable="false"
      class="chakra-icon with-emotion-1lfxhy1"
    ...
    >
      ...
      <path
        ...
        fill="#3c4178"
      ></path>
      <path d="M443 1.5V147L765 335L888 260.5L443 1.5Z" fill="#3c4178"></path>
      <path
      ...
      <path
        ...
        fill="#666db3"
      ></path>
      <path d="M2 656.5L449 916.5V769L131 582L2 656.5Z" fill="#3c4178"></path>
      <path
      ...
      <path
        ...
        fill="#666db3"
      ></path>
      <path d="M0 259L3.5 407L443 146.5V0.5L0 259Z" fill="#666db3"></path>
    </svg>
  );
};
